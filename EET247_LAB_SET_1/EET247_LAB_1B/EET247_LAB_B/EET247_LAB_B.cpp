...
============================================| Complete Changelog |=============================================
| V8 Import Code from CLion 
| + Added a Few Comments to Code
| + Bring Back Use of 'system("pause");' since Linux is no longer being used
| + Moved Actual Assignment to Top of Code 
| + Convert .c to .cpp for Microsoft Visual C++
|
...
| Credits    :
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
| Changelog  : Import Code from CLion 
| + Added a Few Comments to Code
| + Brought Back Use of 'system("pause");' since Linux is no longer being used
| - Removed 'printf(" Press Enter Key to Exit. . .");' 
| + Moved Actual Assignment to Top of Code 
| + Converted .c to .cpp for Microsoft Visual C++
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
*/
#include <stdio.h>
#include <stdlib.h>
...
int main () {
	...
	// A Complex Solution to the Assignment (for personal uses)
    char first_name[100], last_name[100], id[100], age[100], location[100], number[100], email[100]; // [] sets character limit
    FILE * fp;
    ...
    printf("\n Hello, %s %s you are %s years old, your student ID is %s and you live in %s. ", first_name, last_name, age, id, location);
    ...
    printf(" Hello, %s %s you are %s years old and you live in %s. \n\n", first_name, last_name, age, location);

    printf(" ");      // Needed to move 'system("pause");' over
	system("pause");
	fclose(fp);
    return(0);
